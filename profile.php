        ...
        <div class="row site-wrap">
            ...
            <div class="row main-content">
                ...
                <div class="container user-page">
                    <div class="row prf-user-section-wrap">
                        <div class="col-xs-12 col-sm-6 col-md-7">
                            <div class="row prf-image-wrap">
                                <img src="includes/img/default-image.jpg" alt="">
                                <button type="button" data-target=".gp-modal-edit-avatar" data-toggle="modal" class="prf-image-edit"><i class="fa fa-pencil"></i> Editeaza</button>
                            </div>
                    ...
                    <div class="row prf-user-section-wrap">
                        <div class="col-xs-12 prf-user-menu">
